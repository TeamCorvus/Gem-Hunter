...
var Gem = (function() {
    function Gem(width, height, row, column, limit, imgSrc, fps, columns, rows) {
        if(!fps || fps >=33) {
            this.fps = 1;
        } else {
            this.fps = 33 / fps;
     ...
     * @param limit
     */
    Gem.prototype.setLimit = function(limit) {
        this.limit = limit-1;
    };
     ...
     * @param num
     */
    Gem.prototype.setRow = function(num) {
        this.row = num;
        this.rowStart = num;
     ...
     * @param num
     */
    Gem.prototype.setColumn = function(num) {
        this.column = num;
